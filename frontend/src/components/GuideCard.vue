  ...
  >
    ...
    <div class="p-4">
      <div class="flex items-start justify-between gap-2 mb-2">
        <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">{{ props.guide.title }}</h3>
        <span
      ...
      <div class="space-y-1 text-xs text-gray-500">
        <p v-if="props.guide.cabinet_type">
          <span class="font-medium text-gray-700">Type:</span> {{ props.guide.cabinet_type }}
        </p>
        <p v-if="props.guide.drive_model">
          <span class="font-medium text-gray-700">Drive:</span> {{ props.guide.drive_model }}
        </p>
      </div>
      ...
      <div v-if="props.guide.tags && props.guide.tags.length > 0" class="mt-2 flex flex-wrap gap-1">
        ...
        <span v-if="props.guide.tags.length > 3" class="text-xs text-gray-400">
