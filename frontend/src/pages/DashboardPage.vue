...
<template>
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
      <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Total Guides</p>
          </div>
        </div>
      </div>
      ...
      <div v-if="isAdmin" class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
        <div class="flex items-center gap-3">
    ...
    <div class="flex flex-wrap gap-3 mb-8">
      ...
      <button
        @click="goToGuides"
        class="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
      >
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div>
      ...
      <!-- Empty state -->
      <div v-else-if="recentGuides.length === 0" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 border-dashed rounded-lg p-8 text-center">
        ...
        <button
          v-if="isAdmin"
          @click="createNewGuide"
          class="mt-3 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 font-medium"
        >
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
          ...
          class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md dark:hover:shadow-gray-900/30 transition-shadow cursor-pointer"
        >
